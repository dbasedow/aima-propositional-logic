...
public class DPLLSatisfiable {
     ...
     */
    public boolean dpllSatisfiable(SentenceImpl s) {
     ...
     */
    public boolean isEntailed(KnowledgeBase kb, SentenceImpl alpha) {
    ...
    // ordering.
    protected List<PropositionSymbol> getPropositionSymbolsInSentence(SentenceImpl s) {
